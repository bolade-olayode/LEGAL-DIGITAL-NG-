...
export default async function CaseDetailPage({ params }) {
  ...
  if (!simpleCheck) {
    console.error('Case not found with slug:', slug)
    return (
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6">
          <h1 className="text-2xl font-bold text-red-600 mb-4">Case Not Found</h1>
          <p className="text-gray-700 mb-4">Could not find case with slug: <code className="bg-gray-100 px-2 py-1 rounded">{slug}</code></p>
  ...
  // Now fetch full case with relationships
  ...
  console.log('Full case error:', error)
